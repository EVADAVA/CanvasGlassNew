...
NARRATIVE_PATTERNS = [
    ("01", "THE RELUCTANT PROPHET"),
    ("02", "THE SENSUALIST PHILOSOPHER"),
    ("03", "THE EXILE IN AMBER"),
    ("04", "THE SLOW RADICAL"),
    ("05", "THE ALCHEMIST CURATOR"),
    ("06", "THE WOUNDED AESTHETE"),
    ("07", "THE DOUBLE AGENT"),
    ("08", "THE LITURGIST"),
    ("09", "THE GENEROUS ECCENTRIC"),
    ("10", "THE WITNESS OF TRANSFORMATION"),
]
